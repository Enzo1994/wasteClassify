...
Page({
  ...
  onSearch: function () {
    wx.cloud.callFunction({
      ...
      this.setData({ isShowCardDialog: true,keyWordOnShow:this.data.keyword })
      // wx.navigateTo({
      //   url: '../searchResult/searchResult'
      // })

      switch (res.result.categroy) {
        case 1:
          this.setData({searchResult:'可回收垃圾'})
          console.log('可回收垃圾')
          break
        case 2:
          this.setData({ searchResult: '有害垃圾' })

          console.log('有害垃圾')
          break
        case 4:
          this.setData({ searchResult: '厨余垃圾' })

          console.log('厨余垃圾')
          break
        case 8:
          this.setData({ searchResult: '其他垃圾' })
